...
-(void)setAttributes:(NSDictionary*)dataDic
{
	...
	while ((attributeName = [keyEnum nextObject])) {
		...
		if ([self respondsToSelector:sel]) {
            ...
            NSString *value = nil;
            if ([dataDic[dataDicKey] isKindOfClass:[NSNumber class]]) {
                value = [dataDic[dataDicKey] stringValue];
            }
            else if([dataDic[dataDicKey] isKindOfClass:[NSNull class]]){
                value = nil;
            }
            else{
                value = dataDic[dataDicKey];
            }
