...
#define TUTORIAL_DEFAULT_DURATION_ON_PAGE       2.0f
...
@interface ICETutorialController : UIViewController <UIScrollViewDelegate,UITextFieldDelegate,DataRequestDelegate> {
