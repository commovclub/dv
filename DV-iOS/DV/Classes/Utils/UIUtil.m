...
+ (NSString *)getStringWithDoubleDate:(double)doubleDate{
    
    NSDate * date = [NSDate dateWithTimeIntervalSince1970:(doubleDate/1000)];
...
+ (NSString *)getShortStringWithDoubleDate:(double)doubleDate{
