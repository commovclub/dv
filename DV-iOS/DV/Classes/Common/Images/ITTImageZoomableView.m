...
//    [_imageView setDefaultImage:ImageNamed(@"default_image_full_screen.png")];
    if (image.smallUrl) {
        UIImage *smallImage = [[ITTImageCacheManager sharedManager] getImageFromCacheWithUrl:image.smallUrl];
        [_imageView loadImage:image.url placeHolder:smallImage];
    }else{
        [_imageView loadImage:image.url];
    }
