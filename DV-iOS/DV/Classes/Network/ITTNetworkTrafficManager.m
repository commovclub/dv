...
- (void) updateNetwordStatus:(NetworkStatus)status
{
    ...
    switch (status)
    {
        case ReachableViaWiFi:
            _networkType = [[NSString alloc] initWithString:@"wifi"];
            break;
        case ReachableVia3G:
            _networkType = [[NSString alloc] initWithString:@"3g"];
            _isUsing3GNetwork = TRUE;            
            break;
        case ReachableVia2G:
            _networkType = [[NSString alloc] initWithString:@"2g"];
            break;
        case NotReachable:
            _networkType = [[NSString alloc] initWithString:@"unavailable"];
            break;
        default:
            _networkType = [[NSString alloc] initWithString:@"unknown"];
            break;
    }
